        ...
        <ul class="menu">
          ...
          <li class="menu__item menu__item--active" data-background="9f32b8">
            <router-link to="/blog" >
              ...
              </svg><span>Blog</span></router-link>
          </li>
          <li class="menu__item menu__item--active" data-background="e4a924">
            <router-link to="/contact" >
              <svg class="paper-airplane">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#paper-airplane"></use>
              </svg><span>Contact</span></router-link>
          </li>
        </ul>
      </nav>
</header> <!-- //main-head -->
...
function buttonClick() {
  console.log(!this.classList.contains('menu__item--active'))
  if (!this.classList.contains('svg')) {
